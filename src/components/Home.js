    ...
    <div className="orido_tm_hero orido_tm_section" id="home">
      <div className="container">
        <div className="content">
          <div className="details">
            ...
            {/* <img className="svg" src="img/svg/hi.svg" alt="" /> */}
              ...
              <span className="job">Principal/Head of Idea Store Learning at London Borough of Tower Hamlets</span>
            </div>
            <div className="text">
              <p>
                {`I'm`} an MBE-awarded educator, passionate about shaping futures and inspiring learners worldwide through STEM education.
              </p>
            </div>
        ...
        <div className="orido_tm_follow">
          ...
          <ul>
            <li>
              <a href="https://linkedin.com/in/faruk-miah-mbe-00218a298">

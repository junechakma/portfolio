              ...
              >
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <div className="details">
                      <span className="category">Awards 2023</span>
                      <h3 className="title">
                        <span>Mayor of London Adult Learning Awards 2023</span>
                      </h3>
                    </div>
                    <a
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <div className="details">
                      <span className="category">2023 LBTH Staff Awards</span>
                      <h3 className="title">
                        <span>Winner Inspiring Leader - 2023 LBTH Staff Awards</span>
                      </h3>
                    </div>
                    <a
                      className="orido_tm_full_link details_link c-pointer"
